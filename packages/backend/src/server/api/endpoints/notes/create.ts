			...
			try {
				...
				if (err instanceof IdentifiableError) {
					if (err.id === '689ee33f-f97c-479a-ac49-1b9f8140af99') {
						...
						throw new ApiError(meta.errors.noSuchChannel);
					} else if (err.id === 'a817376a-4bcc-11ee-8fd9-15e99585d2ed') {
						throw new ApiError(meta.errors.tooManyPublicNote);
					} else if (err.id === '4653904a-2567-5f3a-2cad-d061dc38e676') {
						throw new ApiError(meta.errors.tooManyDestinations);
					} else if (err.id === 'd5f820ab-13d3-7e50-dad9-74225cd190d0') {
